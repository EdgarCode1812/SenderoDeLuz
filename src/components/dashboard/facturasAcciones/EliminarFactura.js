...
export default function EliminarFacturaClientes({ closeModal, showModalDelete, confirmDelete, butondisableDelete, facturaid }) {
        ...
        <Container fluid className='pr-3 pl-3 pb-3 pt-5 p-md-5 mt-5 panel'>
          <Modal show={showModalDelete} onHide={closeModal}>
            ...
            <Modal.Footer>
              ...
              <Button variant="danger" onClick={() => confirmDelete(facturaid)} disabled={butonDelete}>
