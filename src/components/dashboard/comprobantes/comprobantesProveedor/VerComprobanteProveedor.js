...
// import { getComprobantebyemail } from '../../../../services/apiComprobantes';
...
// export default function VerComprobanteProveedor({ handleBackToMenu }) {
...
//             <h1 className='pt-4'>Mis Comprobantes</h1>
//           </div>
...
//               </thead>
//               <tbody>
//                 {comprobantes && comprobantes.length > 0 && loading ? (
...
//                       </td>
//                       <td className="p-2">
//                         <a href={item.url} download={`Comprobante_${item.email}.pdf`} target="_blank" rel="noopener noreferrer">
