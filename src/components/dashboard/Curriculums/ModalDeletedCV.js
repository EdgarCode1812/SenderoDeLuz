...
export default function ModalDeletedCV( { closeModal, showModalDelete, confirmDelete, butondisableDelete, textAlert, userId} ) {
    ...
    <div>
      <Container fluid className='pr-3 pl-3 pb-3 pt-5 p-md-5 mt-5 panel'>
        <Modal show={showModalDelete} onHide={closeModal}>
          ...
          <Modal.Body>
          ¿Estás seguro de que deseas eliminar el Curriculum de <strong>{textAlert}</strong>?
          </Modal.Body>
          <Modal.Footer>
