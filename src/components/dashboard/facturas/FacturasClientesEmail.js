...
// import { getFacturaClientebyemail } from '../../../services/apiFacturas';
// import { isMobile } from 'react-device-detect';

// export default function FacturasClientesEmail({ handleBackToMenu }) {
...
//     setLoading(false)
//     const userEmail = LocalStorageService.getEmail();
//     try {
//       const facturasData = await getFacturaClientebyemail(userEmail);
//       setLoading(true)
...
//             </>
//           )}
//           <div className='title-facturas text-center p-3'>
//             <h1 className='pt-4'>Complementos de pago</h1>
//           </div>
...
//                       <td className="p-2">
//                         <a href={item.url} download={`factura.xml`}>
//                           Descargar XML
//                         </a>
//                       </td>
//                     </tr>
...
//                   <tr>
//                     <td>
//                       <h1 className='no-items'>No cuentas con ninguna factura registrada</h1>
//                     </td>
//                   </tr>
//                 )}
//               </tbody>
...
import ModalEditarComprobante from '../comprobantes/comprobantesAdmin/ModalEditarComprobante';
import AgregarComprobante from '../comprobantes/comprobantesAdmin/AgregarComprobante';
import ModalEliminarComprobante from '../comprobantes/comprobantesAdmin/ModalEliminarComprobante';
...
export default function FacturasClientesEmail({ handleBackToMenu }) {
  ...
  const fetchGetAllComprobantes = async () => {
    ...
    try {
      const comprobantesData = await getComprobantebyemail(userEmail);
      setLoading(true)
